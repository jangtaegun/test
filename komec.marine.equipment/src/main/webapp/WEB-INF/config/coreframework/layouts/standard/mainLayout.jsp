...
<link rel="stylesheet" href="<c:url value='/css/contents/tip-yellowsimple.css'/>" type="text/css" />
<style type="text/css">
...
<script type="text/javascript" src="<c:url value='/jquery/jquery.poshytip.min.js'/>"></script>
